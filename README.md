...
- [oobabooga/text-generation-webui](https://github.com/oobabooga/text-generation-webui) - A gradio web UI for running Large Language Models like GPT-J 6B, OPT, GALACTICA, LLaMA, and Pygmalion. (4 days ago)
- [tplaner/When](https://github.com/tplaner/When) - PHP Date Recursion library (5 days ago)
