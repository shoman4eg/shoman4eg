...
- [bitrix24/env-docker](https://github.com/bitrix24/env-docker) - Контейнеры для Битрикс (1 day ago)
...
- [itsManjeet/rlxos](https://github.com/itsManjeet/rlxos) - A truly modern implementation of GNU/Linux distribution (3 days ago)
- [dontsovcmc/waterius](https://github.com/dontsovcmc/waterius) - Передача показаний воды по Wi-Fi. Watermeter Wi-Fi transmitter. (4 days ago)
- [DieMetRik/mercury_esphome](https://github.com/DieMetRik/mercury_esphome) -  (4 days ago)
- [stephenh/ts-proto](https://github.com/stephenh/ts-proto) - An idiomatic protobuf generator for TypeScript (4 days ago)
